...
beforeAll(async () => {
  ...
  // Seed the three in-DB owner-input sources.
  await db
    .insert(conversationMessages)
    .values({ conversationId: 1, role: "owner", body: "a chat directive", at: 1_700_000_100_000 });
  await db
    .insert(requestMessages)
    .values({ requestId: 1, author: "owner", body: "a work request", at: 1_700_000_200_000 });
  await db
    .insert(feedback)
